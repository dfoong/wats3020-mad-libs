...
let vehicle = prompt('What is your favourite vehicle?');
...
let precious = prompt('What is a keepsake you would never give away?');

// TODO: A variable named "noiseMaker" for something that makes a sound.
let noiseMaker = prompt('The worst kind of music or sound:');

// TODO: A variable named "crowdBehavior" for something that people do together as a group.
let crowdBehavior = prompt('That thing people do at parties or celebrations:');

// TODO: A variable named "adjective2" for a word used to describe something.
let adjective2 = prompt('How would you describe your best friend in one word?');

// TODO: A variable named "adjective3" for a word used to describe something.
let adjective3 = prompt('Describe your favourite food in one word:');
...
let familyMember = prompt('The family member you get along best with (e.g. sister, brother, father) :');

// TODO: A variable named "organ" for the name of a body organ (e.g. heart, liver, spleen, etc.).
let organ = prompt('Name one body organ (e.g. heart, liver, kidney, lung) :');
...
let thing = prompt('Name an object from your kitchen:');

// TODO: A variable named "thing2" for an object you might give somebody you love.
let thing2 = prompt('Name an object you would give to somebody you love.');

// TODO: A variable named "thing3" for an object you might give somebody you like.
let thing3 = prompt('Name an object you would give to somebody you like.');
